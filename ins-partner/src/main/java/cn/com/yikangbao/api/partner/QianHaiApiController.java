...
public class QianHaiApiController {
    ...
    public ApiResult getOrderStatus(OrderDTO order) throws Exception {
        logger.info("receive qianhai order: {}", order);
        List<OrderDTO> orderDTOList = new ArrayList<>();
        orderDTOList.add(order);
        qianhaiService.synchronousOrderStatus(orderDTOList);
